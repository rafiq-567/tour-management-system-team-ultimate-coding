...
const About = () => {
  return (
    <div className="flex flex-col min-h-screen bg-base-100 dark:bg-gray-900 font-sans p-4 sm:p-8">
      ...
      <div className="bg-base-300 dark:bg-gray-800 p-8 rounded-3xl shadow-2xl w-full max-w-6xl mx-auto border border-gray-200 dark:border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
      ...
      <div className="py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {teamMembers.map((member) => (
            <div
              key={member.id}
              className="bg-base-300 dark:bg-gray-800 rounded-2xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform duration-300"
            >
              <img
                src={member.image}
                alt={member.name}
